"""
Django settings for backend_prd project.
...
WSGI_APPLICATION = 'backend_prd.wsgi.application'
...
if os.getenv('GAE_APPLICATION', None):
    ...
    DEBUG = False
elif os.path.basename(os.getcwd()).endswith('prd'):
    ...
    # SECURITY WARNING: don't run with debug turned on in production!
    DEBUG = True
elif os.path.basename(os.getcwd()).endswith('dev'):
    # Running locally
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
